...
public class TestCase1 {
	...
	public static void main(String[] args) throws IOException, InterruptedException, AWTException {
		...
		//to fetch common  data from properties file
		FileInputStream fis_p = new FileInputStream("./src/test/resources/Day6/TestCase1commondata.properties");
		...
		FileInputStream fis_excel = new FileInputStream("./src/test/resources/Day6/TestCase1.xlsx");
		...
		String e_un = wb.getSheet("Sheet1").getRow(1).getCell(4).getStringCellValue();
		String e_pwd =wb.getSheet("Sheet1").getRow(1).getCell(5).getStringCellValue();
		String role = wb.getSheet("Sheet1").getRow(1).getCell(6).getStringCellValue();
		String ename = wb.getSheet("Sheet1").getRow(1).getCell(7).getStringCellValue();
		String status = wb.getSheet("Sheet1").getRow(1).getCell(8).getStringCellValue();
		String a_us = wb.getSheet("Sheet1").getRow(1).getCell(9).getStringCellValue();
		String a_pwd = wb.getSheet("Sheet1").getRow(1).getCell(10).getStringCellValue();
...
//		driver.findElement(By.xpath("//div[@role='option']//span[normalize-space()='"+role+"']")).click();
		...
		r.keyPress(KeyEvent.VK_ENTER);
		r.keyRelease(KeyEvent.VK_ENTER);
//		driver.findElement(By.xpath("//div[@role='listbox']//span[normalize-space()='" + ename + "']")).click();
		Thread.sleep(1000);
...
//		driver.findElement(By.xpath("//div[@role='option']//span[normalize-space()='" + status + "']")).click();
		...
		//user role
		WebElement role2 = driver.findElement(By.xpath("//div[@class='oxd-select-text-input']"));
		role2.click();
		r.keyPress(KeyEvent.VK_DOWN);
		r.keyRelease(KeyEvent.VK_DOWN);
		r.keyPress(KeyEvent.VK_ENTER);
